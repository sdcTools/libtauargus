...
SWIGEXPORT jboolean JNICALL Java_tauargus_extern_dataengine_TauArgusJavaJNI_TauArgus_1SetTableCellStatus(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jintArray jarg3, jint jarg4) {
  jboolean jresult = 0 ;
  TauArgus *arg1 = (TauArgus *) 0 ;
  long arg2 ;
  long *arg3 = (long *) 0 ;
